...
public class JabRefFrame extends JFrame implements OutputPrinter {
	...
	protected void initActions() {
		...
		openDatabaseOnlyActions.addAll(Arrays.asList(new Object[] {
				 ...
				 * openInspire
				 */
				openPdf, openUrl, openFile, openSpires, /* openInspire, */
	...
	AbstractAction setTableFont = new ShowPrefsAc();

	class ShowPrefsAc extends MnemonicAwareAction {
		public ShowPrefsAc() {
			putValue(NAME, "Set table font");
			putValue(ACCELERATOR_KEY, Globals.prefs.getKey("Set table font"));
		}
